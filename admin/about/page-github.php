<h3><?php esc_html_e( 'Developed on Github', 'polestar' ); ?></h3>
...
<p>
	...
	<?php esc_html_e( "You can watch what's happening with its development and even make contributions yourself.", 'polestar' ); ?>
</p>

...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( '1 Comment', '%1$s Comments', get_comments_number(), 'comments title', 'polestar' ) ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer comments', 'polestar' ) . ' <span class="icon-long-arrow-right"></span>' ); ?></div>
			</div><!-- .nav-links -->

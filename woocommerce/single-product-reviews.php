...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews"><?php _e( 'There are no reviews yet.', 'polestar' ); ?></p>
			...
			<div id="review_form">
				<?php
					...
					if ( $account_page_url = wc_get_page_permalink( 'myaccount' ) ) {
						$comment_form['must_log_in'] = '<p class="must-log-in">' . sprintf( __( 'You must be <a href="%s">logged in</a> to post a review.', 'polestar' ), esc_url( $account_page_url ) ) . '</p>';
					}
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required"><?php _e( 'Only logged in customers who have purchased this product may leave a review.', 'polestar' ); ?></p>

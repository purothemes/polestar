			...
			<div id="review_form">
				<?php
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<p class="comment-form-rating"><label for="rating">' . __( 'Your Rating', 'polestar' ) .'</label><select name="rating" id="rating" aria-required="true" required>
